//using Ara.SmartHSE.Application.Entities.LoRaGateways.Commands.Create;
...
//namespace Ara.SmartHSE.Application.UnitTests.Entities.LoRaGateways.Commands.Create
//{
//    public class LoRaGatewaysCreateHandlerTest : Language
//    {
//        #region Props
...
//        private LoRaGatewaysCreateHandler _handler;
//        private LoRaGatewaysCreateCommand _request;
//        private LoRaGateway _loRaGateway;
//        #endregion

//        public LoRaGatewaysCreateHandlerTest()
//        {
//            _modelRepository = new Mock<IModelRepository>();
//            _loRaGatewayRepository = new Mock<ILoRaGatewayRepository>();
//            _logger = new Mock<ILogger>();
//            _handler = new LoRaGatewaysCreateHandler(_loRaGatewayRepository.Object, _logger.Object, _sharedResources.Object, _modelRepository.Object);
//            _request = new LoRaGatewaysCreateCommand
//            {
//                IndexId = 1,
...
//        [Fact]
//        [Trait("LoRaGatewaysCreateHandlerTest", "Validation Request")]
...
//        [Fact]
//        [Trait("LoRaGatewaysCreateHandlerTest", "Exception")]
...
//        [InlineData(true)]
//        [InlineData(false)]
//        [Trait("LoRaGatewaysCreateHandlerTest", "Check In db")]
...
//            _loRaGatewayRepository.Setup(s => s.FindLoRaBySerialNumAsync(_request.SerialNumber)).ReturnsAsync(loragateway);
...
//            _modelRepository.Setup(s => s.GetByIdAsyncAndInclude(_request.ModelId)).ReturnsAsync(model);
//            _loRaGatewayRepository.Setup(s => s.FindLoRaBySerialNumAsync(_request.SerialNumber)).ReturnsAsync(loragateway);
//            _loRaGatewayRepository.Setup(s => s.HasThisIndexId(_request.IndexId)).ReturnsAsync(true);
...
//        [Fact]
//        [Trait("LoRaGatewaysCreateHandlerTest", "Create")]
...
//            _modelRepository.Setup(s => s.GetByIdAsyncAndInclude(_request.ModelId)).ReturnsAsync(model);
//            _loRaGatewayRepository.Setup(s => s.FindLoRaBySerialNumAsync(_request.SerialNumber)).ReturnsAsync(loragateway);
//            _loRaGatewayRepository.Setup(s => s.HasThisIndexId(_request.IndexId)).ReturnsAsync(false);
//            _loRaGatewayRepository.Setup(s => s.AddAsync(It.IsAny<LoRaGateway>())).ReturnsAsync(_loRaGateway);
//            //Act
